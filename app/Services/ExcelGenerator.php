...
class ExcelGenerator
{
    ...
    private function crear_datos()
    {
        ...
        foreach ($facturas as $key => $factura) {
            $datos_factura = [$factura->fecha, $factura->tipoDeComprobante, $factura->rfcDeEmisor, $factura->nombreDeEmisor, $factura->uuid, $factura->folio, $factura->subTotal, $factura->descuento, $factura->total_iva(), $factura->iva_retencion(), $factura->isr_retencion(), $factura->total];
